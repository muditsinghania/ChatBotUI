$(document).ready(function() {
	...
	var accessToken = "c69b5834f8954e11b5e95de5d361d801"; //API client key: Replace with own Bot Key: api.ai
	...
	function setBotResponse(val) {
		...
		setTimeout(function(){
			if($.trim(val) == '') {
				...
				var BotResponse = val+'</p><div class="clearfix"></div>';
	...
	function scrollingDown(){
		var terminalResultsDiv = document.getElementById('chatCont');
		var terminal= terminalResultsDiv.scrollHeight - terminalResultsDiv.offsetHeight;	
		$("#chatCont").animate({ scrollTop: terminal+5 }, 100);
	}

	$('#chatCont').scroll(function(){scrollFunction()});

	function scrollFunction() {
		var terminalResultsDiv = document.getElementById('chatCont');
		if ((terminalResultsDiv.scrollTop - (terminalResultsDiv.scrollHeight - terminalResultsDiv.offsetHeight))<1) {
        showNewText();
    }else{
    	$('.down').hide();
    }
